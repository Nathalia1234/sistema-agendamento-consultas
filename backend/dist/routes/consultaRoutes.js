...
router.delete("/cancel/:id", consultaController_js_1.cancelConsulta);
// Criar nova consulta
router.post("/", consultaController_js_1.createConsulta);
// Listar todas as consultas
router.get("/", consultaController_js_1.getConsultas);
// Buscar consulta por ID
router.get("/:id", consultaController_js_1.getConsultaById);
// Atualizar consulta
router.put("/:id", consultaController_js_1.updateConsulta);
// Deletar consulta
router.delete("/:id", consultaController_js_1.deleteConsulta);
// Exportar o roteador
