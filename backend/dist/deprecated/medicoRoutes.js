...
const medicoController_js_1 = require("../deprecated/medicoController.js");
// Cria uma instância do roteador
const router = (0, express_1.Router)();
// Criar médico
router.post("/", medicoController_js_1.criarMedico);
// Listar todos os médicos
router.get("/", medicoController_js_1.listarMedicos);
// Buscar médico por ID
router.get("/:id", medicoController_js_1.buscarMedicoPorId);
// Atualizar médico
router.put("/:id", medicoController_js_1.atualizarMedico);
// Deletar médico
router.delete("/:id", medicoController_js_1.deletarMedico);
// Agenda do medico
router.get("/:id/agenda", medicoController_js_1.getAgendaMedico);
